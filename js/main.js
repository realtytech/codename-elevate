...
$("form").submit(function (e) {
  ...
  const configSelector = `#${formName} select[name="config"]`;
  ...
  if (config == "") {
    alert("Please select your preferred Configuration");
  }
  console.log(config);


  var currentUrl = window.location.href;
  var project = 'Codename Elevate';
  ...
  if (utm_source) {
    ...
    } else if (utm_source == "Facebook" || utm_source == "fb") {
      source = "Facebook";
  ...
  var sfdcData = {
    "req":
    {
      ...
      "remarks": "Configuration Preferred:" + config + "Source:" + utm_source + "|Medium:" + utm_medium + "|term:" + utm_term + "|content:" + utm_content + "|campaign:" + utm_campaign + "|URL:" + currentUrl.substring(0, 255),
